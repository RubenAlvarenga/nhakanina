    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cant_minima', models.DecimalField(verbose_name=b'Cantidad Minima', max_digits=2, decimal_places=0)),
                ('cant_maxima', models.DecimalField(verbose_name=b'Cantidad Maxima', max_digits=2, decimal_places=0)),
                ...
                ('tipoConcepto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, verbose_name=b'Tipo Carrera | Concepto', to='aranceles.TipoCarreraConcepto')),
            ],
            options={
